...
songplay_table_create = ("""
                            ...
                            (songplay_id SERIAL NOT NULL PRIMARY KEY, start_time timestamp NOT NULL,user_id int NOT NULL, 
...
user_table_create = ("""
                            ...
                            (user_id int PRIMARY KEY, first_name varchar, lastname varchar,
...
time_table_create = ("""
                            ...
                            (start_time timestamp NOT NULL PRIMARY KEY, hour int, day int,
